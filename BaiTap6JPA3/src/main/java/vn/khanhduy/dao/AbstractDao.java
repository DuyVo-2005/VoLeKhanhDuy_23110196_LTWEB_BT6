...
public abstract class AbstractDao<T> {
	...
	/*
	 * public List<T> findAll(String nameQuery) { EntityManager enma =
	 * JPAConfigs.CreateEntityManager(); TypedQuery<T> query =
	 * enma.createNamedQuery(nameQuery, entityClass); return query.getResultList();
	 * }
	 */
